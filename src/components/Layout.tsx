    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="flex items-center justify-between px-5 py-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold tracking-tight text-sidebar-foreground">Kursverwaltung</h1>
              <p className="text-xs text-sidebar-foreground/60">Bildungszentrum</p>
            </div>
          </div>
          <button
      ...
      <div className="lg:pl-64">
        <header className="lg:hidden flex items-center gap-4 px-4 py-3 border-b bg-card sticky top-0 z-30">
          ...
          <span className="font-semibold text-sm">Kursverwaltung</span>
        </header>
